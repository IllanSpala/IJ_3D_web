...
app.listen(8087, async () => {
    ...
    await page.evaluate(async () => {
        ...
        // Simulate string IDs for items like what might be happening
        await putAll('pedidos_v2', [{ id: 'ped_1', nome_cliente: 'Cliente Teste' }]);
        await putAll('pedidos_itens', [{ id: 'it_1', pedido_id: 'ped_1', nome_avulso: 'Item Teste' }]);
        await putAll('producao_pedidos', [{ id: 100, pedido_id: 'ped_1' }]);
